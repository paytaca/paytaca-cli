        ...
        <div class="grid">
          <div class="span-6">
            <div class="card">
              ...
              <div class="field"><label class="field-label">Token</label><select class="field-input" x-model="swapToken"><template x-for="t in swapTokens" :key="t.category"><option :value="t.category" x-text="t.symbol + '  ·  ' + t.category.slice(0,10) + '…' + t.category.slice(-6)"></option></template></select></div>
              <div class="segmented" style="margin-bottom:14px">
